        ...
        <div class='portlet box green-meadow bordered'>
            ...
            <div class='portlet-body'>
                                    ...
                                    <div class="form-group form-horizontal filter">
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Nama Kualitas</label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control form-filter input-sm" name="nama_kualitas">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                ...
                <div class='table-container'>
                    ...
                    <table class="table table-bordered table-hover" id="tableMKualitas">
                        <thead>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        ...
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('MKualitas/getDatatable/') ?>"
            },
            "order": [
                [1, "asc"]
            ]
