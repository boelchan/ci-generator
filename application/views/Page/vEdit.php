                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-12'>
                                <div class='form-group'>
                                    ...
                                    <?php if ($row->page == 'nama_perusahaan') : ?>
                                        <div class='col-md-5'>
                                            <input type="text" class="form-control"  name="content" placeholder="" value="<?php echo $row->content ?>"> 
                                        </div>
                                    <?php endif ?>
                                    ...
                                    <?php if ($row->page == 'telepon') : ?>
                                        <div class='col-md-5'>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder=""  name="content" value="<?php echo $row->content ?>"> 
                                            </div>
