<div class="page-sidebar-wrapper">
	...
	<div class="page-sidebar navbar-collapse collapse">
		...
		<ul class="page-sidebar-menu <?php echo $page_sidebar_menu_closed ?> " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
			...
			<li class="heading">
				<h3 class="uppercase">Transaksi</h3>
			</li>
			...
			<li class="nav-item <?php if ($this->uri->segment(1) == 'SisaDO') echo 'active' ?> ">
				<a href="<?php echo site_url('SisaDO') ?>" class="nav-link">
					<i class="icon-directions"></i>
					<span class="title">Sisa DO</span>
				</a>
			</li>
			<?php endif ?>
			...
			<li class="nav-item <?php if ($this->uri->segment(2) == 'pemasukan') echo 'active' ?> ">
				<a href="<?php echo site_url('laporan/pemasukan') ?>" class="nav-link">
					<i class="icon-login"></i>
					<span class="title">Pemasukan</span>
				</a>
			</li>	
			<li class="nav-item <?php if ($this->uri->segment(2) == 'pengeluaran') echo 'active' ?> ">
				<a href="<?php echo site_url('laporan/pengeluaran') ?>" class="nav-link">
