        ...
        <div class='portlet light bordered'>
            ...
            <div class='portlet-body'>
                                    ...
                                    <div class="form-group form-horizontal filter">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <select name='gudang_id' class='form-control form-filter select2-ajax' data-url='<?php echo site_url('form/dd/MGudangModel') ?>'></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Kualitas</label>
                                                <div class="col-md-8">
                                                    <select name='kualitas_id' class='form-control form-filter select2-ajax' data-url='<?php echo site_url('form/dd/MKualitasModel') ?>'></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Tonase</label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control form-filter input-sm" name="tonase">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                ...
                <div class='table-container'>
                    ...
                    <table class="table table-bordered table-hover" id="tableGaramGudang">
                        <thead>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        src: $("#tableGaramGudang"),
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('GaramGudang/getDatatable/') ?>"
            },
            "order": [
                [1, "asc"]
            ]
