                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-12'>
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-4'>
                                        <?php echo form_dropdown('wilayah_id', $wilayah_dd, (isset($_GET['wilayah']) ? $_GET['wilayah'] : 1), 'class="form-control"') ?>
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-12'>
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-4'>
                                        <input type="text" class="form-control" name="nama_kantor" id="nama_kantor" placeholder="Nama Kantor" value="" />
                                    </div>
                                </div>
                            </div>
