...
<html lang="en">
    ...
    <style>
        ...
        .login {
            background-image:url('<?php echo base_url() ?>/assets/global/img/sampul.jpg')!important;
        ...
        <div class="content">
            ...
            <?= form_open(site_url('auth/login_action'), 'class="login-form"', ''); ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix"   type="text" autocomplete="off" placeholder="masukkan email anda" name="identity" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="masukkan password anda" name="password" /> </div>
         ...
         <div class="copyright"> 2019 © ODHE-R</div>
        <!--[if lt IE 9]>
