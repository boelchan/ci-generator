        ...
        <div class='portlet light bordered'>
            ...
            <div class='portlet-body'>
                                    ...
                                    <div class="form-group form-horizontal filter">
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control form-filter input-sm" name="nama_gudang">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <select name='kantor_id' class='form-control form-filter select2-ajax' data-url='<?php echo site_url('form/dd/MKantorModel') ?>'></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                ...
                <div class='table-container'>
                    ...
                    <table class="table table-bordered table-hover" id="tableMGudang">
                        <thead>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        ...
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('MGudang/getDatatable/') ?>"
            },
            "order": [
                [1, "asc"]
            ]
