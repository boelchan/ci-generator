        ...
        <div class='portlet light bordered'>
            ...
            <div class='portlet-body'>
                                    ...
                                    <div class="form-group form-horizontal filter">
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control form-filter input-sm" name="nama_wilayah">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                ...
                <div class='table-container'>
                    ...
                    <table class="table table-bordered table-hover" id="tableMWilayah">
                        <thead>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        ...
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('MWilayah/getDatatable/') ?>"
            },
            "order": [
                [1, "asc"]
            ]
